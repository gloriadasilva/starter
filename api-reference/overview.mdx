...
```
  ...
  <Card>
    ...
    <div style={{ backgroundColor: "yellow", padding: "10px", borderRadius: "8px", width: "100%", textAlign: "center" }}>
     <a  
    href="https://www.themoviedb.org/login?to=read_me&redirect=%2Freference%2Fintro%2Fgetting-started" 
    rel="noopener noreferrer"
    style={{ display: "block", padding: "10px", backgroundColor: "green", color: "white", borderRadius: "8px", textAlign: "center", width: "100%" }}
     >
    Get API Key
    </a>
    </div>
